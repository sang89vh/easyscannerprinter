...
public class CloudActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPicker = mApp.getPicker();
    }


    protected void onActivityPickingResult(final int requestCode, final int resultCode, final Intent data) {
    ...
    protected void onActivitySaveResult(final int requestCode, final int resultCode, final Intent data) {
